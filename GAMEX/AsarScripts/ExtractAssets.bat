...
:Start
echo Place a headerless GAMEX ROM named %ROMName% in this folder, then type the number representing what version %ROMName% is.
echo 0 = GAMEX V1
echo 1 = GAMEX V2
...
echo You need to place a GAMEX ROM named %ROMName% in this folder before you can extract any assets^^!
goto :Mode
